...
<div class="bx-authform">
	...
	<?if ($arResult['ERRORS']):?>
		...
		<?if ($arResult['AUTH_SERVICES']):?>
			...
			<form name="<?= $arResult['FORM_ID'];?>" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>" class="header_auth_form">

				<div class="bx-authform-formgroup-container">
					<div class="bx-authform-label-container"><?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_LOGIN');?></div>
					<div class="bx-authform-input-container">
						<input type="text" name="<?= $arResult['FIELDS']['login'];?>" maxlength="255" value="<?= \htmlspecialcharsbx($arResult['LAST_LOGIN']);?>" class="input_auth_login">
					</div>
				</div>
				...
				<div class="bx-authform-formgroup-container">
					...
					<div class="bx-authform-input-container">
						<?if ($arResult['SECURE_AUTH']):?>
							...
							<?endif?>
							<input type="password" name="<?= $arResult['FIELDS']['password'];?>" maxlength="255" autocomplete="off" class="input_auth_password">
						</div>
					</div>
					...
					<?if ($arResult['CAPTCHA_CODE']):?>
						...
						<?if ($arResult['STORE_PASSWORD'] == 'Y'):?>
							<div class="bx-authform-formgroup-container">
								<div class="checkbox">
									<label class="bx-filter-param-label">
										<input type="checkbox" id="USER_REMEMBER" name="<?= $arResult['FIELDS']['remember'];?>" value="Y" class="input_auth_remember_pass">
							...
							<div class="bx-authform-formgroup-container">
								<input type="submit" class="btn btn-primary submit_auth_form" name="<?= $arResult['FIELDS']['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_SUBMIT');?>" />
							</div>
